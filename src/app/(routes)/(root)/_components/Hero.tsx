...
export function Hero() {
    ...
    return (
        <section className="relative pt-24 sm:pt-32 pb-16 sm:pb-20 px-4 overflow-hidden" id="Home">
            ...
            <StaggeredCards className="mx-auto max-w-6xl" duration={0.2}>
                ...
                <StaggeredCards className="text-center" duration={0.1}>
                    ...
                    <p className="mb-6 sm:mb-8 text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed px-4">
                        Taskr is a free, self-hostable alternative to Jira. Full Kanban and Scrum support with powerful features
                        your team will actually love. Own your data, forever.
                    </p>
                    ...
                    <div className="flex justify-center mb-8 sm:mb-12 px-4">
                        ...
                        >
                            ...
                            <code className="text-sm text-foreground font-mono">npx create-taskr-app@latest</code>
                            {copied ? (
                    ...
                    <div className="rounded-xl border border-border bg-card/50 p-3 sm:p-4 shadow-2xl backdrop-blur">
                        ...
                        <div className="flex gap-0">
                            ...
                            <div className="hidden md:flex flex-col w-48 border-r border-border pr-3 mr-3 gap-2">
                                ...
                                {["Dashboard", "My Tasks", "Board", "Projects", "Team", "Calendar"].map((item, i) => (
                                    <div
                                        key={item}
                                        className={`flex items-center gap-2 px-2 py-1.5 rounded text-xs ${i === 3 ? "bg-primary/10 text-primary" : "text-muted-foreground"}`}
                                    >
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <div className="flex items-center justify-between mb-4 pb-3 border-b border-border">
                                    <div>
                                        <h3 className="text-sm font-semibold text-foreground">Marketing Site</h3>
                                    ...
                                    {[
                                        {
                                            ...
                                            color: "bg-blue-500",
                                            tasks: [
                                                { title: "Update landing page copy", priority: "Medium", assignee: true },
                                                { title: "Create social media assets", priority: "Low", assignee: true },
                                            ],
                                        },
                                        {
                                            name: "In Progress",
                                            color: "bg-yellow-500",
                                            tasks: [
                                                { title: "Implement dark mode", priority: "High", assignee: true },
                                                { title: "Fix mobile navigation", priority: "Urgent", assignee: true },
                                            ],
                                        },
                                        {
                                            name: "Review",
                                            color: "bg-purple-500",
                                            tasks: [{ title: "API documentation", priority: "Medium", assignee: true }],
                                        },
                                        {
                                            name: "Done",
                                            color: "bg-green-500",
                                            tasks: [
                                                { title: "Setup CI/CD pipeline", priority: "High", assignee: true },
                                                { title: "Database schema design", priority: "High", assignee: true },
                                            ],
                                        },
                                    ].map((column) => (
                                        <div key={column.name} className="min-w-40 sm:min-w-45 flex-1">
                                            ...
                                            <div className="space-y-2">
                                                {column.tasks.map((task, j) => (
                                                    ...
                                                    >
                                                        <p className="text-xs font-medium text-foreground mb-2 line-clamp-2">{task.title}</p>
                                                        <div className="flex items-center justify-between">
                                                            <span
                                                                className={`text-[10px] px-1.5 py-0.5 rounded ${task.priority === "Urgent"
