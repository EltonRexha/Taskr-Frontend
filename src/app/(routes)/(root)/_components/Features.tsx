...
import { BarChart3, Clock, Kanban, Shield, Users, Zap, Calendar, Target, Layers, Github } from "lucide-react"

const features = [
    {
        icon: Github,
        title: "Open Source",
        description: "Contribute and view the code, completely free without any subscriptions added!",
    },
    {
        icon: Kanban,
        title: "Kanban Boards",
        description: "Visualize your workflow with drag-and-drop boards that adapt to your process.",
    },
    {
        icon: Target,
        title: "Scrum & Sprints",
        description: "Full Scrum support with sprint planning, backlog grooming, and retrospectives.",
    },
    {
        icon: Users,
    ...
    },
    {
        icon: BarChart3,
        title: "Analytics",
        description: "Track velocity, burndown, and team performance with powerful insights.",
    },
    {
        icon: Clock,
        title: "Time Tracking",
            ...
            <div className="mx-auto max-w-6xl">
                <StaggeredCards className="text-center mb-12 sm:mb-16">
                    ...
                    <p className="text-muted-foreground max-w-2xl mx-auto text-sm sm:text-base">
                        Powerful features designed for modern teams. From startups to enterprises.
                    </p>
                </StaggeredCards>
                ...
                <StaggeredCards className="grid gap-4 sm:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 mt-4 sm:mt-6">
