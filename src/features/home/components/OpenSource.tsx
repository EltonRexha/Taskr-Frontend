...
const benefits = [
  {
    ...
    title: "Own Your Data",
    description:
      "Self-host on your own infrastructure. Your data never leaves your servers.",
  },
  {
    icon: Code2,
    title: "Fully Customizable",
    description:
      "Fork, modify, and extend. Build the exact features your team needs.",
  },
  {
    icon: Users,
    title: "Community Driven",
    description:
      "contributors shaping the future of open source project management.",
  },
  {
    icon: Globe,
  ...
  },
  {
    ...
    description:
      "One-click deploy to Vercel, Railway, or any Docker-compatible platform.",
  },
  {
    icon: Heart,
    title: "Free Forever",
    description:
      "MIT licensed. No premium tiers, no feature gates, no surprises.",
  },
];
        ...
        <div className="mx-auto max-w-6xl">
          <StaggeredCards className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto text-sm sm:text-base">
              Taskr is 100% open source under the MIT license. Self-host it,
              customize it, or contribute to make it better for everyone.
            </p>
          </StaggeredCards>
