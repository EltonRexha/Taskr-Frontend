...
const footerLinks = {
  ...
  Developers: [
    ...
    { label: "API Reference", href: "https://docs.taskr.dev/api" },
    {
      ...
      href: "https://docs.taskr.dev/self-hosting",
    },
    {
      label: "Contributing",
      href: "https://github.com/taskr/taskr/blob/main/CONTRIBUTING.md",
    },
  ],
  Community: [
    {
      label: "GitHub Discussions",
      href: "https://github.com/taskr/taskr/discussions",
    },
  ...
  Resources: [
    {
      label: "Report a Bug",
      href: "https://github.com/taskr/taskr/issues/new",
    },
    {
      label: "Request Feature",
      href: "https://github.com/taskr/taskr/issues/new?template=feature_request.md",
    },
    {
      label: "Security Policy",
      href: "https://github.com/taskr/taskr/security/policy",
    },
    {
      label: "License (MIT)",
      href: "https://github.com/taskr/taskr/blob/main/LICENSE",
    },
  ],
};
